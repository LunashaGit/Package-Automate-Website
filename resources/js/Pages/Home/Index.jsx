    ...
    const [block] = useState([
        {
            ...
            description:
                "A Composer package is a collection of PHP code that is bundled together and distributed as a single package.",
        },
        {
            title: "NPM",
            language: "Javascript",
        ...
        <DefaultLayout auth={props.auth} errors={props.errors}>
            <div className="flex flex-col gap-24 sm:gap-8">
                <div className="py-12 flex flex-col sm:flex-row  justify-center items-center gap-12 sm:gap-44 ">
                    <ApplicationLogo className="drop-shadow-2xl max-w-1/2 max-h-1/2 sm:w-1/5 sm:h-1/5 transition ease-in duration-100 hover:scale-125" />
                    <div>
                        <div className="py-10">
                            <h1 className="text-4xl text-white font-bold text-center">
                                Package Automate
                            </h1>
                            <h3 className="text-white font-bold">Simplify your Developer's Life!</h3>
                        </div>
